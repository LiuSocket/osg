...
IF   (FFMPEG_LIBAVFORMAT_FOUND AND FFMPEG_LIBAVDEVICE_FOUND AND FFMPEG_LIBAVCODEC_FOUND AND FFMPEG_LIBAVUTIL_FOUND AND FFMPEG_LIBSWRESAMPLE_FOUND AND FFMPEG_LIBAVFILTER_FOUND AND STDINT_OK)
    ...
    IF (FFMPEG_STDINT_INCLUDE_DIR)
        SET(FFMPEG_INCLUDE_DIRS
            ...
            ${FFMPEG_STDINT_INCLUDE_DIR}/libavfilter
        )
    ENDIF()
    ...
    MESSAGE(STATUS "    ${FFMPEG_LIBAVFORMAT_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBAVDEVICE_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBAVCODEC_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBAVUTIL_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBSWRESAMPLE_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBSWSCALE_LIBRARIES}")
    MESSAGE(STATUS "    ${FFMPEG_LIBAVFILTER_LIBRARIES}")
