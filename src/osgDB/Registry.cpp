...
Registry::Registry()
{
    ...
    addFileExtensionAlias("jpg",  "sffmpeg");
    addFileExtensionAlias("jpe",  "sffmpeg");
    addFileExtensionAlias("jpeg", "sffmpeg");
    addFileExtensionAlias("jp2", "sffmpeg");
    addFileExtensionAlias("tif",  "sffmpeg");
    addFileExtensionAlias("tiff", "sffmpeg");
    addFileExtensionAlias("gif",  "sffmpeg");
    addFileExtensionAlias("png",  "sffmpeg");

    addFileExtensionAlias("avi",   "sffmpeg");
    addFileExtensionAlias("flv",   "sffmpeg");
    addFileExtensionAlias("mov",   "sffmpeg");
    addFileExtensionAlias("ogg",   "sffmpeg");
    addFileExtensionAlias("ogv",   "sffmpeg");
    addFileExtensionAlias("mpg",   "sffmpeg");
    addFileExtensionAlias("mpv",   "sffmpeg");
    addFileExtensionAlias("wmv",   "sffmpeg");
    addFileExtensionAlias("mkv",   "sffmpeg");
    addFileExtensionAlias("webm",  "sffmpeg");
    addFileExtensionAlias("mjpeg", "sffmpeg");
    addFileExtensionAlias("mp4",   "sffmpeg");
    addFileExtensionAlias("dv",    "sffmpeg");
    addFileExtensionAlias("sav",   "sffmpeg");
    addFileExtensionAlias("3gp",   "sffmpeg");
    addFileExtensionAlias("sdp",   "sffmpeg");
    addFileExtensionAlias("m2ts",  "sffmpeg");
    addFileExtensionAlias("mp3",   "sffmpeg");
    addFileExtensionAlias("flac",  "sffmpeg");
    addFileExtensionAlias("wav",   "sffmpeg");
    addFileExtensionAlias("nut",   "sffmpeg");
...
// #endif
...
#if defined(DARWIN_QTKIT) && !defined(USE_SFFMPEG)
    ...
    addFileExtensionAlias("otf",    "freetype");  // OpenType Font using PostScript
