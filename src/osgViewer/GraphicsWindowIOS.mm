...
bool GraphicsWindowIOS::realizeImplementation()
{
    ...
    osg::notify(osg::DEBUG_INFO) << "GraphicsWindowIOS::realizeImplementation / ownsWindow: " << _ownsWindow << std::endl;
    ...
    if (_ownsWindow)
    {
        ...
        osg::notify(osg::DEBUG_INFO) << "GraphicsWindowIOS::realizeImplementation: INFO: Created UIWindow with bounds '" << window_bounds.size.width << ", " << window_bounds.size.height << "' (points)." << std::endl;
    ...
    osg::notify(osg::DEBUG_INFO) << "GraphicsWindowIOS::realizeImplementation / view: " << theView << std::endl;
