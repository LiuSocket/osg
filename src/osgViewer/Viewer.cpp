...
void Viewer::updateTraversal()
{
    ...
    OSG_NOTIFY(osg::INFO)<<"databasePager: "<< _scene->getDatabasePager() << std::endl;
    OSG_NOTIFY(osg::INFO)<<"shaderstatemanager: "<< osgDB::Registry::instance()->getSharedStateManager() << std::endl;
    ...
    {
        OSG_NOTIFY(osg::INFO)<<"IncrementalCompileOperation is valid"<<std::endl;
