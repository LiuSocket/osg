...
{
    OSG_NOTICE<<"IncrementalCompileOperation::add"<<std::endl;
...
void IncrementalCompileOperation::mergeCompiledSubgraphs(const osg::FrameStamp* frameStamp)
{
    ...
    OSG_INFO<<"IncrementalCompileOperation::mergeCompiledSubgraphs() "<< ((int) _toCompile.size()) << std::endl;
        ...
        ++itr)
    {
        ...
        OSG_INFO<<"IncrementalCompileOperation::mergeCompiledSubgraphs(): cs = " << cs <<std::endl;
        if (cs->_attachmentPoint.lock(group))
        {
            OSG_INFO<<"IncrementalCompileOperation::mergeCompiledSubgraphs(): adding " << cs <<std::endl;
...
{
    osg::NotifySeverity level = osg::INFO;
    OSG_NOTIFY(level)<<"   compileSets running" <<std::endl;
        ...
        )
    {
        ...
        OSG_NOTIFY(level)<<"   compileSets got something" <<std::endl;
